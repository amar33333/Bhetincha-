...
class SectionEditViewBusiness extends Component {
  constructor(props) {
    super(props);
  ...
  onFormSubmit = event => {
    ...
    if (Object.keys(body).length) {
      this.props.onSectionUpdateBusiness({ body });
    }
  };
  ...
  render() {
    return (
      <Card>
        <CardHeader>
          <strong>Update Section Data</strong>
        </CardHeader>
        <CardBody>
...
export default SectionEditViewBusiness;
